...
if 'SERVER_SOFTWARE' in os.environ:
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
            'NAME': 'CourseComment',                      # Or path to database file if using sqlite3.
            # The following settings are not used with sqlite3:
            'USER': 'zzq',
            'PASSWORD': 'zzq_sjtu',
...
SECRET_KEY = 'e6pns(b189kmyc@+f5+h_c&9!sdh3!6p20=%f(*5o^diq5#%+g'
...
ROOT_URLCONF = 'CourseComment.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'CourseComment.wsgi.application'
